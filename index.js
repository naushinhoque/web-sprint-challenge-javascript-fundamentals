...
// The nested Function can access the variable internal because both are within the function, myFunction. They are both in the same scope allowing them to interact. 
...
const zooAnimals = [
  ...
  */
  ...
  //console.log('forEach Task', animalNames(zooAnimals));
  ...
  */
  ...
  //console.log('filter', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(zooAnimals){
    ...
    const Avg = zooAnimals.reduce((accumalator, item)=>{
      return accumalator + item.population
    },0);
    return Avg;
  }
  //console.log('reduce', USApop(zooAnimals));
 ...
 console.log('consume', consume('Mary','Smith', greeting))
